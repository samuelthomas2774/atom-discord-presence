...
class StatusView {
    constructor() {
        ...
        reconnectButton.addEventListener('click', () => AtomDiscordPresence.client.connect());
        this.element.appendChild(reconnectButton);
        ...
        this.element.appendChild(disconnectButton);
        ...
        this.element.appendChild(forceUpdateButton);
        ...
        this.element.appendChild(resetTimestampButton);
        ...
        this.subscriptions.add(AtomDiscordPresence.client.observeStatus(status => {
            ...
            reconnectButton.style.display = status.connected ? 'none' : 'block';
            disconnectButton.style.display = !status.connected ? 'none' : 'block';
            forceUpdateButton.style.display = !status.connected ? 'none' : 'block';
        }));
    }
